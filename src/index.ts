...
export default class Drawflow {
	...
	click(e:any) {
		...
		case 'main-path':
			...
			case 'point':
				...
				position(e: any) {
	  if (e.type === "touchmove") {
		  this.e_pos_x = e.touches[0].clientX;
		  this.e_pos_y = e.touches[0].clientY;
		} else {
			this.e_pos_x = e.clientX;
		this.e_pos_y = e.clientY;
	}
	...
	dragEnd(e: any) {
		...
		if (e.type === "touchend") {
			this.e_pos_x = this.mouse_x;
			this.e_pos_y = this.mouse_y;
			ele_last = document.elementFromPoint(this.e_pos_x, this.e_pos_y);
		} else {
			this.e_pos_x = e.clientX;
			this.e_pos_y = e.clientY;
			ele_last = e.target;
